...
public class RecCPUBD 
{
    ...
    public String[] getRecCPUBD(String escsoft) 
    {
        ...
        ResultSet rs = null;
        String query = "SELECT coremin, clockmin, corerec, clockrec FROM Software INNER JOIN RecomendacaoCpu" 
        + "ON id_recomendacaocpu = cod_reccpu WHERE nome_soft = \"" + escsoft + "\";";
